...
public final class AIfCompoundCompoundStmt extends PCompoundStmt
{
    private PIfStmt _ifStmt_;

    public AIfCompoundCompoundStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfCompoundCompoundStmt(
    ...
    {
        ((Analysis) sw).caseAIfCompoundCompoundStmt(this);
    }
